...
_DECOMPOSE_PROMPT = (
    ...
    "address the cause it diagnosed (an epistemic fix for an incentive problem is a category "
    "error → flawed); and do any inductive leaps overreach? Give the argument's STRONGEST reading, "
...
_GAPS_PROMPT = (
    ...
    "what must it be leaning on — especially about an alternative it endorses, e.g. that judgment "
    "is trustworthy); invalid steps; equivocations; internal inconsistencies.\n"
